...
function SRPGLayer:new()
    ...
    self.units = {}
    table.insert(self.units, P1Unit(27,14))
    table.insert(self.units, P2Unit(7,14))
    local e1 = E1Unit(68,14)
    e1.facing_left = true
    local e2 = E2Unit(40,14)
    e2.facing_left = true
    table.insert(self.units, e1)
    table.insert(self.units, e2)
    
    table.insert(self.units, U1Unit(28, 13))
    table.insert(self.units, U1Unit(30, 13))
    table.insert(self.units, U1Unit(29, 14))
    table.insert(self.units, U1Unit(28, 15))
    table.insert(self.units, U1Unit(30, 15))

    table.insert(self.units, U3Unit(8, 13))
    table.insert(self.units, U3Unit(10, 13))
    table.insert(self.units, U3Unit(9, 15))
    table.insert(self.units, U2Unit(8, 15))
    table.insert(self.units, U2Unit(10, 15))
    table.insert(self.units, U2Unit(9, 13))

    table.insert(self.units, E3Unit(16, 15))
    table.insert(self.units, E3Unit(15, 14))
    table.insert(self.units, E3Unit(16, 13))

    table.insert(self.units, E4Unit(34, 10))
    table.insert(self.units, E4Unit(36, 10))
    table.insert(self.units, E4Unit(38, 10))

    table.insert(self.units, E5Unit(34, 18))
    table.insert(self.units, E5Unit(36, 18))
    table.insert(self.units, E5Unit(38, 18))
end
